<template>
  <div v-if="uiStore.dataModalOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(47,36,25,0.3)] px-4 py-6" @click.self="uiStore.setDataModalOpen(false)">
